...
function agregar(e) {
	e.preventDefault();
	let nombreProductoNuevo = document.getElementById(
		"nombreProductoNuevo"
	).value;
	let proveedorProductoNuevo = document.getElementById(
		"proveedorProductoNuevo"
	).value;
	let codigoProductoNuevo = document.getElementById(
		"codigoProductoNuevo"
	).value;
	let cantidadProductoNuevo = document.getElementById(
...
function eliminar(e) {
	...
	let codigoProductoEliminado = document.getElementById(
		"codigoProductoEliminado"
	).value;
	if (codigoProductoEliminado !== "" && codigoProductoEliminado !== null) {
		localStorageActualizado = JSON.parse(
			localStorage.getItem("productosNuevos")
		);
